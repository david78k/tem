...
# get token
#curl -d '{"auth":{"passwordCredentials":{"username": "admin", "password": "4077kts."}}}' -H "Content-type: application/json" http://localhost:5000/v2.0/tokens
#curl -d '{"auth":{"passwordCredentials":{"username": "admin", "password": "4077kts."}}}' -H "Content-type: application/json" http://localhost:8774/v2.0/tokens
